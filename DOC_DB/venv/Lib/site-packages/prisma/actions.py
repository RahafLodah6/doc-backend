...
class DocumentActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Document records ordered by the content field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Document record ordered by the author field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Document records by content values
